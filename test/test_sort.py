from src.my_sort import InfinitesimalSort, return_subarray, best_quasi_sort
...
sort_cases = [
        ([0.1406, 0.4243, 0.967, 0.334], [0.1406, 0.334, 0.4243, 0.967])
    ]
...
sort_cases = [
        ([0.1406, 0.4243, 0.967, 0.534], [0.1406, 0.4243, 0.534, 0.967])
    ]
